...
When you first login to [RECAP](./access.md) you should see the home page with the *Welcome to the Imperial Research Computing Access Portal* message. To see the Research Groups you are a member of:
